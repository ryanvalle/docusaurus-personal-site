...
export default function Running() {
  ...
  return (
    <Layout
      title={`Running Stuff | ${siteConfig.title}`}
      description="Hello I'm Ryan, and this is just some highlights on my running shenanigans.">
      <GenericHeader
        header="Running Stuff"
        subtext="Just a page dedicated to my running addiction and accomplishments"
      />
      <main>
        <TextBlock>
          ...
          <p>Follow my running shenanigans on <Link to="https://www.strava.com/athletes/18849820">Strava</Link>!</p>
          <h2 className={styles.header}>Upcoming Races</h2>
          <DataTable columns={upcomingRacesColumns} data={upcomingRaces}/>
          <h2 className={styles.header}>Previous Races</h2>
